...
CapoCompose is a text-based language for writing music notation that compiles to MNX (Music Notation eXchange format). It lets you define instruments, create parts, arrange scores, and write music programmatically using intuitive syntax.
## A Complete Example
